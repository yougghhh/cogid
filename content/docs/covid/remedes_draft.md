...
Il faut bien noter que le consensus scientifique ne porte pas avant tout sur l'inefficacité de l'HCQ, mais bien sur le fait que la plupart des études concluant à cette inefficacité sont de bien meilleure qualité que que les études concluant à son efficacité[^cmipaul]. En particulier, il est largement reconnu qu'un essai randomisé contrôlé est beaucoup plus fiable qu'une étude observationnelle rétrospective pour évaluer l'efficacité d'un traitement d'une maladie aïgue comme le covid-19 (ref).
 ...
 * l'examen des études de Raoult et al. met en lumière de graves manquements méthodologiques, quand ce ne sont pas tout bonnement des fraudes, qu'ils ont été incapables de justifier (voir ci-dessous);
* la plupart des études de bonne qualité sur l'HCQ concluent à son inefficacité (voir ci-dessous).

5. **Quels sont les éléments montrant que les études de Raoult et al. sur l'HCQ ne sont pas fiables?**

Les élements donnés ci-dessous ne sont pas exhaustifs. Pour plus de détails, voir notamment (ref).
 ...
 * Le groupe contrôle (non soumis au traitement) et le groupe traité (soumis au traitement) n'étaient pas homogènes notamment en termes d'âge, d'état clinique et de sexe, et aucun ajustement statistique n'a été fait pour tenter de corriger ces biais.
 ...
 * L'étude devait initialement porter sur 2 semaines, avec des mesures aux jours 1,4,7 et 14, mais ne comporte finalement des résultats de tests que pour les jours 0 à 6. 
 * Pour plusieurs patients, les résultats des tests fluctuent d'un jour à l'autre, et les résultats de plusieurs jours sont manquants. Cela met a minima en question la pertinence de la mesure de charge virale pour évaluer l'état réel des patients.
 * Il semble que la majorité des patients testés positifs dans le groupe contrôle l'ont été au moyen d'un test PCR différent (non quantitatif) que les autres patients, or il est plus facile de falsifier un tel test [^alexsam-fals].
 * Certains des résultats fournis (pour un même patient, à une même date) ont changé entre la version préliminaire de l'article et la version finale. 
 

La [deuxième étude](https://www.sciencedirect.com/science/article/abs/pii/S1477893920302179) (Million et al., 1081 patients), portant sur la mortalité, ne comporte pas de groupe contrôle, de sorte qu'il est impossible d'évaluer si le traitement fait mieux qu'un placebo ou un autre traitement. Une version préliminaire de l'article (qui n'a visiblement pas été acceptée pour publication) comparait la mortalité du groupe traité par HCQ à la mortalité de patients soumis à d'autres traitements dans d'autres hôpitaux, mais sans information suffisante pour assurer la comparabilité des groupes. On peut également noter que parmi les patients traités avec HCQ, un grand nombre n'avaient que de très légers symptômes. L'étude exclut de plus du groupe traité les patients décédés avant 3 jours complets de traitement, de sorte qu'ils ne sont pas compatibilisés dans l'estimation de la mortalité de ce groupe.

La [troisième étude](https://www.sciencedirect.com/science/article/pii/S1477893920302817) (Lagier et al., 3767 patients), les patients dont l'état s'aggravait initialement avec le traitement (moins de 3 jours sous HCQ) étaient comptabilisés dans le groupe de contrôle au lieu d'être exclus de l'étude, augmentant ainsi indûment la proportion de patients gravement malades dans le groupe de contrôle[^cmi-rep-fiolet];

Il n'est pas normal que des études avec de tels manquements soient publiées. On notera que la première a été publiée en 24h (délai endéans lequel un réel travail de revue par les pairs est impossible), dans un journal (IJAA) dont l'éditeur en chef (J.M. Rolain) est co-auteur de la publication (et membre de l'IHU de Marseille). Les deux autres études sont publiées dans un journal (TMID) dont un des éditeurs associés (P. Gautret) est également co-auteur et membre de l'IHU. Cela n'implique pas que le processus d'évaluation de la publication est biaisé, mais on peut écarter cette éventualité moins facilement a priori que si ce conflit d'intérêt potentiel n'existait pas.
...
La [première étude](https://www.sciencedirect.com/science/article/pii/S0924857920300996) (Gautret et al.) portait sur un petit de nombre de patients (42 initialement, 36 après exclusion de patients). 
 * Le groupe contrôle (non soumis au traitement) et le groupe traité (soumis au traitement) n'étaient pas homogènes notamment en termes d'âge, d'état clinique et de sexe, et aucun ajustement statistique n'a été réalisé pour tenter de corriger ces biais.
 * Des 26 patients soumis initialement au traitement (contre 16 dans le groupe de contrôle), 6 ont été exclus du groupe recevant de l'HCQ, dont 4 suite à une détérioration de leur état (3 admis aux soins intensifs, 1 décédé, 1 nauséeux et 1 sorti de l'hôpital). L'étude ne portant que sur la charge virale des patients (mesurée par RT-PCR) et non leur état clinique global, la détérioration de l'état de 4 patients dans le groupe traité n'est pas reflété dans les conclusions de l'étude. 
 * L'étude devait initialement porter sur 2 semaines, avec des mesures aux jours 1,4,7 et 14, mais ne comporte finalement des résultats de tests que pour les jours 0 à 6. 
 * Pour plusieurs patients, les résultats des tests fluctuent d'un jour à l'autre, et les résultats de plusieurs jours sont manquants. Cela met a minima en question la pertinence de la mesure de charge virale pour évaluer l'état réel des patients.
...
Rien ne peut être déduit avec certitude de ces conflits d'intérêt potentiels, mais ils constituent une explication plausible au fait que des études si fortement biaisées aient été acceptées pour publication (et non rétractées a posteriori). La société possédant la revue où le premier article a été publié a émis des  [réserves](https://www.isac.world/news-and-publications/official-isac-statement) a posteriori: 

> *ISAC Board believes the article does not meet the Society’s expected standard, especially relating to the lack of better explanations of the inclusion criteria and the triage of patients to ensure patient safety*

6. **Pourquoi la plupart des études concluant à l'inefficacité de l'HCQ sont-elles plus fiables?**

Les exemples ci-dessus montrent que la publication d'un article dans une revue scientifique ne garantit hélas pas la qualité du travail publié. Il faut que le travail de revue par les pairs soit correctement effectué et que les éditeurs validant ce travail soient indépendants des auteurs de l'étude.

. Le caractère rétrospectif (par opposition à prospectif) signifie que les critères d'attribution du traitement plutôt que du placebo aux patients (outre des critères évidents comme l'absence de contre-indications connues) n'ont pas été déterminés et rendus publics préalablement à l'étude. Il est possible aussi que la manière dont l'effet du traitement va être évalué n'ait pas été (complètement) spécifiée au préalable.
Le caractère observationnel (par opposition à contrôlé) implique quant à lui que rien n'a été fait a priori pour assurer la comparabilité des groupes contrôle et testé, qui différeront typiquement en termes de distribution d'âges, de sexe, de co-morbidités,...

On analyse a posteriori des données sur des patients, certains soumis, d'autres non, au traitement, et on établit des statistiques sur base de ces données. 


Cela signifie qu'on a comparé *a posteriori* l'état de santé de patients soumis ou non à un traitement à base d'HCQ, sans connaître les raisons précises (outre l'absence de contre-indications évidentes) qui ont conduit le médecin à prescrire un traitement plutôt qu'un autre. 

---

La plupart des études concluant à l'efficacité de l'HCQ sont des études observationnelles rétrospectives. Cela signifie qu'on a comparé *a posteriori* l'état de santé de patients soumis ou non à un traitement à base d'HCQ, sans connaître les raisons précises qui ont conduit le médecin à prescrire un traitement plutôt qu'un autre. 

Lorsque ce n'est pas le cas, on peut, comme pour les études rétrospectives, utilser des méthodes statistiques (modélisation multivariée) pour essayer de corriger a posteriori ces biais, mais ces méthodes (modélisation multivariée) sont faillibles, en particulier parce qu'elles reposent sur des hypothèses dont on peut au mieux tester la "non mise en défaut" flagrante, mais jamais véritablement vérifier (au mieux, elles constituent une approximation acceptable de la réalité).`

C'est pour cela que les spécialistes concluent à l'inefficacité de l'HCQ - lorsqu'on fait la synthèse des études fiables (évaluées comme telles par des critères transparents établis au préalable), on se rend compte que le résultat global est l'inefficacité de ce traitement.
...
La plupart des études concluant à l'efficacité de l'HCQ sont des études rétrospectives, dans lesquelles rien n'a été fait a priori pour assurer la comparabilité entre le groupe soumis au traitement et le groupe non soumis au traitement. En particulier, les deux groupes ont généralement des caractéristiques différentes en termes d'âge, de sexe, de comorbidités (facteurs de risque préalables pour la maladie), d'état clinique au démarrage du traitement,...
Il existe des méthodes statistiques (modélisation multivariée) visant à corriger a posteriori ces biais de "confusion", mais elles requièrent que les données concernant tous les facteurs pouvant affecter le résultat du traitement soient disponibles, ce qui n'est pas toujours le cas (ne serait-ce que parce qu'on ne connaît généralement pas tous les facteurs de risque pour une pathologie nouvelle). Elles postulent également que l'influence des différents facteurs peut être modélisée par des fonctions simples, ce qui est au mieux une approximation acceptable.

Non seulement les études rétrospectives sont intrinsèquement biaisées, mais plusieurs études rétrospectives sur l'HCQ n'utilisent que partiellement les méthodes statistiques pour les atténuer, voire n'en utilisent pas du tout. Pour évaluer si le niveau de biais d'une étude rétrospective est acceptable, il existe des outils tels que [ROBINS-I](https://training.cochrane.org/handbook/current/chapter-25). Ce guide répertorie 7 types de biais, et propose de les évaluer sur une échelle à 4 niveaux: faible, modéré, fort, et critique. Lorsqu'une étude rétrospective présente un biais critique, elle doit être considérée comme non fiable. C'est la méthode d'évaluation qu'ont notamment suivi les auteurs de cette méta-analyse. On peut voir dans les fichiers fournis en complément de l'article principal pourquoi de nombreuses études rétrospectives ont du être écartées de l'analyse.

Les études concernant des essais contrôlés randomisés sont, en général, nettement moins sujettes à des biais, car la méthode de constitution des groupes traités et non traités (répartition par tirage au sort) est telle que les deux groupes sont équilibrés en termes des caractéristiques des patients (pour autant que le nombre de patients participants soit suffisamment grand). Elle garantit donc également que les deux groupes sont équilibrés au niveau des facteurs inconnus qui pourraient affecter le résultat du traitement (et pour lesquels aucun ajustement statistique a posteriori n'est possible).
On vérifie généralement à l'issue du tirage au sort si l'équilibre entre les groupes est effectivement atteint pour les facteurs de risque connus (voir par exemple la table 1 de cet article, montrant que l'équilibre est satisfaisant pour l'essai randomisé contrôlé RECOVERY). 
Lorsque ce n'est pas le cas, on peut, comme pour les études rétrospectives, utilser des méthodes statistiques pour essayer de corriger a posteriori les biais de confusion.

Les essais contrôlés randomisés de grande envergure qui ont été menés pour évaluer différents traitements potentiels de la covid-19, Recovery et Solidarity, ont conclu à l'inefficacité de l'HCQ (ref). Une méta-analyse (travail d'analyse et de synthèse d'une série d'études, prenant notamment en compte le niveau de biais des études incluses et la précision de leurs résultats), qui portait sur une majorité d'études rétrospectives, a abouti aux mêmes conclusions, bien que les résultats individuels de ces études soient en partie divergents. D'autres méta-analyses portant uniquement sur des essais contrôlés randomisés ont également conclu à l'inefficacité de l'HCQ (cela est moins surprenant dans la mesure où les résultats individuels sont moins discordants).
...
[^risquealpha] Cette vidéo relate quelques-unes des découvertes importantes réalisées grâce à la méthodes ECR
