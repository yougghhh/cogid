...
Cela fait douter certains de la pertinence de l'étude, dans la mesure où la covid-19 est beaucoup plus léthale chez les personnes âgées (voir les commentaires en bas de page sur [medRxiv](https://www.medrxiv.org/content/10.1101/2020.09.09.20184143v1)). On peut également se demander pourquoi il y a proportionnellement beaucoup plus de perdus de vue dans le groupe HCQ (1503 sur 3320) que dans le groupe non traité (848 sur 4572). Et il est très improbable qu'aucun de ces perdus de vue n'ait été hospitalisé ou ne soit décédé, comme les auteurs le rapportent (on peut estimer ces probabilités en effectuant un test statistique sur base des pourcentages d'admission à l'hôpital et de décès chez les individus suivis).
Enfin, la table 4 de l'article, qui décrit les principaux résultats après ajustement par un modèle multivarié, est atypique à plusieurs égards, mais la discussion de ces éléments dépasse le cadre de vulgarisation visé ici.
